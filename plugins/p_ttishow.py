...
from info import ADMINS, LOG_CHANNEL, SUPPORT_CHAT, MELCOW_NEW_USERS, MELCOW_VID, CHNL_LNK, GRP_LNK , BF_LOGS
...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        if not await db.get_chat(message.chat.id):
            ...
            await bot.send_message(BF_LOGS, script.LOG_TEXT_G.format(message.chat.title, message.chat.id, total, r_j))       
